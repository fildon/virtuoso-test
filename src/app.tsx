...
export const App = () => {
	return (
		<main className="stack center">
			...
			<p>This is a minimal proof of concept usage of react-virtuoso. You can inspect the source code over at <a href="https://github.com/fildon/virtuoso-test">virtuoso-test</a></p>
